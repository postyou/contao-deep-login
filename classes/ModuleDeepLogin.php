 ...
 */
class ModuleDeepLogin extends \Module
{
     ...
     * @var string
     */
    protected $strTemplate = 'mod_login_deep_1cl';
    ...
    public function generate()
    {
        ...
        if (\Input::post('FORM_SUBMIT') == 'tl_login' &&
            \Input::post('FORM_ID') == $this->form_id)
        {
    ...
    protected function compile()
    {
        ...
        {
            $this->import('FrontendUser', 'User');
            $this->strTemplate = ($this->cols > 1) ? 'mod_logout_deep_2cl' : 'mod_logout_deep_1cl';
        ...
        $this->strTemplate = ($this->cols > 1) ? 'mod_login_deep_2cl' : 'mod_login_deep_1cl';
        ...
        $this->Template->form_id = $this->form_id;
    }
}
